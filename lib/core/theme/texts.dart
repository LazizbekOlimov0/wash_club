...
class ApparenceKitTextTheme extends ThemeExtension<ApparenceKitTextTheme> {
  ...
  factory ApparenceKitTextTheme.build() {
    return const ApparenceKitTextTheme(
      primary: TextStyle(fontSize: 16, fontWeight: FontWeight.w400),
  ...
  @override
  ApparenceKitTextTheme copyWith({
    TextStyle? primary,
  ...
  @override
  ApparenceKitTextTheme lerp(
      covariant ThemeExtension<ApparenceKitTextTheme>? other,
      double t,
      ) {
    if (other is! ApparenceKitTextTheme) return this;
    return ApparenceKitTextTheme(
